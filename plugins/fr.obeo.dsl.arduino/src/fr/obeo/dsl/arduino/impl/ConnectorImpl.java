 ...
 * <ul>
 *   <li>{@link fr.obeo.dsl.arduino.impl.ConnectorImpl#getPin <em>Pin</em>}</li>
 *   <li>{@link fr.obeo.dsl.arduino.impl.ConnectorImpl#getModule <em>Module</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectorImpl extends EObjectImpl implements Connector {
	...
	protected EClass eStaticClass() {
		return ArduinoPackage.Literals.CONNECTOR;
	}
	...
	public Pin getPin() {
		if (pin != null && pin.eIsProxy()) {
			...
			if (pin != oldPin) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArduinoPackage.CONNECTOR__PIN, oldPin, pin));
			}
		}
		return pin;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArduinoPackage.CONNECTOR__PIN:
				if (resolve) return getPin();
				return basicGetPin();
			case ArduinoPackage.CONNECTOR__MODULE:
