...
public class ParameterCallImpl extends InstructionImpl implements ParameterCall {
	...
	protected EClass eStaticClass() {
		return ArduinoPackage.Literals.PARAMETER_CALL;
	}
		...
		if (definition != null && definition.eIsProxy()) {
			...
			if (definition != oldDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArduinoPackage.PARAMETER_CALL__DEFINITION, oldDefinition, definition));
			}
		}
		return definition;
	}
	...
	public void setDefinition(ParameterDefinition newDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoPackage.PARAMETER_CALL__DEFINITION, oldDefinition, definition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArduinoPackage.PARAMETER_CALL__DEFINITION:
