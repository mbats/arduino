...
public class WhileImpl extends ControlImpl implements While {
		...
		if (condition != null && condition.eIsProxy()) {
			...
			if (condition != oldCondition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArduinoPackage.WHILE__CONDITION, oldCondition, condition));
			}
		}
		return condition;
	}
	...
	public void setCondition(BooleanOperator newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoPackage.WHILE__CONDITION, oldCondition, condition));
	}
