...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.arduino.Loop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoopItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Loop_init_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Loop_init_feature", "_UI_Loop_type"),
				 ArduinoPackage.Literals.LOOP__INIT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Loop_end_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Loop_end_feature", "_UI_Loop_type"),
				 ArduinoPackage.Literals.LOOP__END,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArduinoPackage.Literals.LOOP__INSTRUCTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArduinoPackage.Literals.LOOP__INSTRUCTIONS,
		...
		newChildDescriptors.add
			(createChildParameter
				(ArduinoPackage.Literals.LOOP__INSTRUCTIONS,
				 ArduinoFactory.eINSTANCE.createInit()));

		newChildDescriptors.add
			(createChildParameter
				(ArduinoPackage.Literals.LOOP__INSTRUCTIONS,
				 ArduinoFactory.eINSTANCE.createEnd()));
	}
