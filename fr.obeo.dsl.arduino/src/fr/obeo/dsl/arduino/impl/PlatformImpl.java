 ...
 * <ul>
 *   <li>{@link fr.obeo.dsl.arduino.impl.PlatformImpl#getPins <em>Pins</em>}</li>
 *   <li>{@link fr.obeo.dsl.arduino.impl.PlatformImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlatformImpl extends EObjectImpl implements Platform {
	...
	public EList<Pin> getPins() {
		if (pins == null) {
			pins = new EObjectContainmentEList<Pin>(Pin.class, this, ArduinoPackage.PLATFORM__PINS);
		}
		return pins;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoPackage.PLATFORM__NAME, oldName, name));
	}
