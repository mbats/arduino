...
public class SetImpl extends InstructionImpl implements Set {
	...
	protected EClass eStaticClass() {
		return ArduinoPackage.Literals.SET;
	}
		...
		if (variable != null && variable.eIsProxy()) {
			...
			if (variable != oldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArduinoPackage.SET__VARIABLE, oldVariable, variable));
			}
		}
		return variable;
	}
	...
	public void setVariable(Variable newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoPackage.SET__VARIABLE, oldVariable, variable));
	}
